        ...
        with torch.no_grad():
            ...
            if iteration < opt.iterations:
                ...
                L = build_scaling_rotation(
                    torch.cat([gaussians.get_scaling, torch.ones_like(gaussians.get_scaling)], dim=-1),
                    gaussians.get_rotation).permute(0, 2, 1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[6000, 10000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[6000, 10000])
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[6000, 10000])
